...
Subject: 5 days old Tg(elavl3:H2B-HuCGCamp6s) in smh background, paralyzed with bungarotoxin
...
All datasets are available on NIRD at doi indicated in the manuscript
 ...
 - Data for panel D-E: 2 files per sample, 1 containing ON responding cells and the otehr OFF responding cells, e.g. 
...
This file was used to generate figure 3B-C
