...
Subject: 5 days old Tg(GFAP:gal4);Tg(UAS:GCamp6s) in smh background, paralyzed with bungarotoxin
...
In total 10 control datasets and 12 mutant datasets were included in the analysis.
...
Large ROI were drawn along the ventricle lining. Each ROI consisted of multiple cells
...
Master files: "GLIA_analysis_perfish", using function "plot_response_v2.m"
This code does:
	...
	- Calculate DFF for the entire recording using the average activity of the entire trace as baseline
