% LOAD DATA AND CALCULATE DFF WITH THE DETECTED GLIA REGIONS
...
path='W:\Percy\2022_11_28\20221128_14_15_08_20221128GFAPgal4UASsmhctrlF02\Aligned\celldetection_manual\'
cd(path)
...
cfg.n_trials=5;
cfg.LengthBaseline=30; %this needs to be in seconds. eg 30 s baseline duration ... 
...
[amplitude]=plot_response_v2 (results)